...
# # argocd notification
# resource "kubectl_manifest" "create_argocd_notif_configmap" {
#   yaml_body = templatefile("./helm_argocd/configmap-argocd-notifications.yaml.tpl", {
#       "prefix" : "${var.prefix}"
#       "domain" : "${var.domain}"
#   })
...
# resource "kubectl_manifest" "create_argocd_notif_secret" {
#   yaml_body = templatefile("./helm_argocd/secret-argocd-notifications.yaml.tpl", {
#     "github_pat" : "${var.github_pat}"
#   })
