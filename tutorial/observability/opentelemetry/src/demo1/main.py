...
from utils import PrometheusMiddleware, metrics, setup_otlp

APP_NAME = os.environ.get("APP_NAME", "otlp-app-a")
EXPOSE_PORT = os.environ.get("EXPOSE_PORT", 8000)
OTLP_GRPC_ENDPOINT = os.environ.get(
    "OTLP_GRPC_ENDPOINT", "http://tempo.monitoring:4317"
)

TARGET_ONE_HOST = os.environ.get("TARGET_ONE_HOST", "otlp-app-b")
TARGET_TWO_HOST = os.environ.get("TARGET_TWO_HOST", "otlp-app-c")
